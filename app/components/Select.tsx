...
const Select = ( {options, selectedRegion, setSelectedRegion}: SelectProps) => {
    ...
    return (
        <div className="md:w-1/5 relative">
            ...
            {isOpen && <div className="absolute bg-white rounded-lg shadow-lg z-10 w-full border-gray-4 overflow-hidden" id="region-menu" role="listbox" aria-expanded={isOpen} tabIndex={0}>
